...
from openapi_server.models.kafka_delivery_configuration import KafkaDeliveryConfiguration  # noqa: E501
...
class DataDeliveryMechanism(Model):
    ...
    def __init__(self, data_delivery_method=None, kafka_delivery_configuration=None):  # noqa: E501
        """DataDeliveryMechanism - a model defined in OpenAPI
