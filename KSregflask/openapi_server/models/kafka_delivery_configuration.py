...
class KafkaDeliveryConfiguration(Model):
    ...
    def __init__(self, num_partitions=None, clean_up_policy=None, compression_type=None, retention_bytes=None, retention_ms=None):  # noqa: E501
        """KafkaDeliveryConfiguration - a model defined in OpenAPI
